...
export const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Store lead in localStorage (simulating database)
        ...
        <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Call us Mon-Fri 8AM-6PM</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@northernpines.com</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Pine Street<br />Northern Valley, NH 03304</p>
                  </div>
                </div>
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-green-800 text-white px-8 py-4 rounded-lg font-semibold hover:bg-green-700 transition-colors duration-200"
              >
                Send Message
              </button>
            </form>
